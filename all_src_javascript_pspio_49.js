...
function calBrut(e) {
	...
	let nomZ = document.getElementById("node").value;
	let remuTotaleArondiZ = remunerationTotale.toFixed(2);
	let tauxDeRemuArondiZ = tauxDeRemuneration.toFixed(2);
	...
	/*if(tjm > 0 || nbKmParjour >= 0 && nbCvFx >= 0) {
	  ...
	  setTimeout(function() {*/
		...
		document.getElementById('nom778').innerHTML = nomZ ;  
		...
		document.getElementById('remuTotaleArondi778').innerHTML = remuTotaleArondiZ + "€"; 
		document.getElementById('remuTotaleAnArondi777').innerHTML = remuTotaleAnArondi + "€"; 
		document.getElementById('tauxDeRemuArondi778').innerHTML = tauxDeRemuArondiZ + "%"; 
