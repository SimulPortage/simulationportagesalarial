...
function calBrut(e) {
	...
	/*if(tjm > 0 || nbKmParjour >= 0 && nbCvFx >= 0) {
	  ...
	  setTimeout(function() {*/
		...
		document.getElementById('nom778').innerHTML = nom ;  
		...
		document.getElementById('remuTotaleArondi778').innerHTML = remuTotaleArondi + "€"; 
		document.getElementById('remuTotaleAnArondi777').innerHTML = remuTotaleAnArondi + "€"; 
		document.getElementById('tauxDeRemuArondi778').innerHTML = tauxDeRemuArondi + "%"; 
...
function generatePDF() {
	let element ; 
	if (document.getElementById('section-simulation-fr').style.display == 'block') {
		element = document.getElementById('simulation-777Z');
	} else {
		element = document.getElementById('simulation-777');
		}
	...
	var width777 = element.offsetWidth ; 
	var height777 = element.offsetHeight ; 
	var opt = {
