...
function cal(e) {
	...
	areaTjm.appendChild(tjm);
	areanbJourParMois.appendChild(nbJourParMois);
	areatjmParMois.appendChild(tjmParMois);
	areasalaireBArondi.appendChild(salaireBArondi);
	areasalaireBAnArondi.appendChild(salaireBAnArondi);
	areasalaireNetImposable.appendChild(salaireNetImposable);
	areasalaireNetImposableAnnuel.appendChild(salaireNetImposableAnnuel);
	areatotalFrais.appendChild(totalFrais);
	arearevenuNetFr.appendChild(revenuNetFr);
	areaparticipation.appendChild(participation);
	areaparticipationannuelle.appendChild(participationannuelle);
	arearemuTotaleArondi.appendChild(remuTotaleArondi);
	arearemuTotaleAnArondi.appendChild(remuTotaleAnArondi);
	areatauxDeRemuArondi.appendChild(tauxDeRemuArondi);
